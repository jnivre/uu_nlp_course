...
\vspace{0.2cm}
\noindent
Training a model should take somewhere between 10 seconds and a few minutes, depending on the size of the training set. If it takes longer (or crashes), notify the lab instructor.\footnote{%
...
{\tt -c} &The name of the parsing model, which has to be trained beforehand. 
