...
\item What tagsets exist for your native language? List the ones you
  ...
  of them in more detail.% \textcolor{UUred}{[$>$ 10
...
\item In the HMM lab we have investigated key sequences and produced
  ...
  Please motivate your answer. %\textcolor{UUred}{[$>$ 10
%    sentences]}
...
on January 15th.%\todo[inline, color=green!50]{FC: added submission format requirements}
