...
\paragraph{Important:} When you have finished the annotation, you must use the "Export Corpus" key to download it to your computer. This puts it in the downloads folder, from which you may need to copy it to your working directory for the final comparison. Unfortunately, the current version of UD Annotatrix inserts an extra blank line after each sentence. You have to remove this line manually before you use MaltEval to compare your annotations with those of another group (see below).
