...
Upload the following to {\it Studentportalen} {\bf before
  20:00h November 11th.}\\In order to pass you must provide answers to all exercises and achieve at least 75\% of the points (15/20 points).
\begin{itemize}[noitemsep,topsep=0.2cm]
