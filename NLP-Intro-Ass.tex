...
%replace {\tt python} by simply {\tt python3} in the above command.
%Ask your teacher if you are uncertain.
\todo[inline]{The command used to say use python3 but python is now python 3 by default
on our server. There was a comment about python version which I removed because
it assumed they might try to use their own system which I don't want to
encourage}
