...
\end{center}
Let us now start exploring the sense-tagged data using the Python interpreter. Copy the file {\tt wsd\_code.py} from {\tt /local/kurs/nlp/semantics/} to your working directory and start the Python interpreter with the command {\tt python3}.
\begin{center}
\fbox{
\scalebox{0.95}{
...
\textbf{before 20:00h December 16th}. In order to pass you must provide
