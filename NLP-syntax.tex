...
color=blue!40]{FC@JN: I changed that to make it look consistent with
  the other assignments. Miryam and I usually used a max of 4 pages,
  but we can discuss this and maybe raise the max to 5 pages for this
  assignment.}

\section{How should we name this section}
\todo[inline, color=blue!40]{FC thinks that we should add a section
  here to make this assignment fit the looks of the other
  assignments. Unfortunately, I could not come up with a good proposal
  of how to name it...}
\noindent
