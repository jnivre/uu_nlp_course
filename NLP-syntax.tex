...
December 8th at 20h00. Later submissions will be considered failed
...
%Submit your assignment as a PDF file in Studentportalen no later than
%Friday December 8th at 20:00. Later submissions will be considered
%failed submissions and assessed after the final re-submission deadline
%on January 15th. % \todo[inline, color=yellow!40]{FC: Maybe we should
%  insert the same text here as we have in all other assignments? At
%  least, we should give the point scale and say how many points we
%  expect them to reach in order to pass.}
