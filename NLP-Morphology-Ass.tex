...
add new methods, or modify the main program, as you see fit. To get inspiration, you can consult the sections on stemming in the textbook. The goal is to reach at least 85\% accuracy 
...
\item Code for a lemmatizer that achieves at least 85\% accuracy on the development set.
\item A discussion of at least 5 remaining error types.
\end{itemize}
